// ahat: I have made changes/additions in WifiManager.h and WifiManager.cpp to add get/read functions for SSID, password
// constructor that uses them, and callback when wifi is idle
...
class WiFiManager
{
  public:
    ...
    boolean       autoConnect();
    // ahat: I need this to be able to pass the credentials with which to connect
